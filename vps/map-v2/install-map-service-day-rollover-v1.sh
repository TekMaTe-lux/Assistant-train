...
# Cas de référence 88788 : à 00:23 le 6, le temps du service du 5 vaut 24:23.
python3 - <<'PY'
now = 23 * 60          # 00:23 après minuit, minutes depuis 00:00
rail = 24 * 60 + now   # 24:23 sur le jour de service J-1
arr_theoretical = 24 * 60 + 21
arr_real = arr_theoretical + 10
assert rail == 1463
assert arr_theoretical == 1461
assert arr_real == 1471
assert arr_theoretical <= rail < arr_real
