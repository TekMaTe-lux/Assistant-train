...
(function loadLabetaillereModules(){
  ...
  load('./assets/home-major-alerts-core.js?v=20260923-10', 'lb-home-major-alert-core');
  ...
  load('./assets/lb-community-map-bridge-v1.js?v=20260923-stoplogic-1', 'lb-community-map-bridge-v1');
